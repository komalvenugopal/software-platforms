                ...
                <div class="row">
                    <div class="col-md-5 col-md-push-7">
                        <div class="banner_content">
                            ...
                            <a href="http://localhost/carbooking/vehical-details.php?vhid=2" class="btn">Read More <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section-padding gray-bg">
        <div class="container">
            <div class="section-header text-center">
                ...
                <p>There are many variations of cars available and you can choose the fuel type and book a car on the date you wanted and the time you wanted. We offer best customer satisfaction. We will be updating the website with the mew models available within your region... </p>
            </div>
            <div class="row">
