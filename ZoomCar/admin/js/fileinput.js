 ...
 */
(function ($) {
    "use strict";    $.fn.fileinputLocales = {};    String.prototype.repl = function (from, to) {
    ...
    $.fn.fileinput = function (option) {
        ...
        return this.each(function () {
            var $this = $(this), data = $this.data('fileinput'), defaults,
                ...
                lang = options.language || $this.data('language') || 'en';            if (!data) {
    ...
    };    $.extend($.fn.fileinput.defaults, $.fn.fileinputLocales.en);    $.fn.fileinput.Constructor = FileInput;    /**
