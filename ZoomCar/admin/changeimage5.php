...
if(strlen($_SESSION['alogin']) == 0) {
    ...
    if(isset($_POST['update'])) {
        ...
        $query->execute();        $msg = "Image updated successfully";    }
    ?><!doctype html>
<html lang="en" class="no-js"><head>
	...
	<title>Zoom Car | Admin Update Image 5</title>	<!-- Font awesome -->
		...
		<div class="content-wrapper">
			<div class="container-fluid">				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Vehicle Image 5 </h2>						<div class="row">
							<div class="col-md-10">
  	        	  ...
  	        	  <?php if($error) {?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } elseif($msg) {?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?><div class="form-group">
...
<?php
    ...
    $cnt = 1;
    if($query->rowCount() > 0) {
        foreach($results as $result) {	?><div class="col-sm-8">
