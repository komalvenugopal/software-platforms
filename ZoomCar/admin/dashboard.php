...
<html lang="en" class="no-js"><head>
	...
	<title>Zoom Car | Admin Dashboard</title>	<!-- Font awesome -->
...
<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">				<div class="row">
					<div class="col-md-12">						<h2 class="page-title">Dashboard</h2>
...
<?php
	...
	window.onload = function(){
		...
		window.myDoughnut = new Chart(doctx).Pie(doughnutData, {responsive : true});		// Dougnut Chart from doughnutData
