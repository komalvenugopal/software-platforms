        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">komalvenugopal@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline: </p>
              <a href="tel:61-1234-5678-09">+1-(314)2015408</a> </div>
...
<?php } else {    echo "Welcome To Car Booking System";
} ?>
          </div>
        </div>
      </div>
...
$email = $_SESSION['login'];
   ...
   if($query->rowCount() > 0) {
       foreach($results as $result) {           echo htmlentities($result->FullName);
       }
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="page.php?type=news">News</a></li>
