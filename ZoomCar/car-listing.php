...
</div><?php $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
$results = $query->fetchAll(PDO::FETCH_OBJ);
$cnt = 1;
    ...
    foreach($results as $result) {  ?>
      ...
      <div class="sidebar_widget">
        ...
        <div class="widget_heading">
          <h5><i class="fa fa-car" aria-hidden="true"></i> <a href="./visited-vehicles-recent.php">Recently Visited Cars</a></h5>
          <h5><i class="fa fa-car" aria-hidden="true"></i> <a href="./visited-vehicles-most.php">Most Visited Cars</a></h5>
        </div>
